...
# =========================================================================
# ⚠️ ID КАНАЛІВ ДЛЯ 7 ПАПОК ЛОГІВ
# ПЕРЕВІР КОЖЕН ID ЩЕ РАЗ, СКОПІЮВАВШИ ЙОГО НАПРЯМУ З DISCORD
# (ПКМ по каналу -> Copy Channel ID), А НЕ З EXCEL/ТАБЛИЦЬ
# =========================================================================
BAN_LOG_CHANNEL_ID = 1489741516971966655
JOIN_LEAVE_LOG_CHANNEL_ID = 1524853896822915173
ROLE_LOG_CHANNEL_ID = 1489741698841182260
NICKNAME_LOG_CHANNEL_ID = 1489741658487656529
MESSAGE_LOG_CHANNEL_ID = 1489741740180242492
...
async def on_member_update(before, after):
    ...
    # --- НІКНЕЙМИ (тільки поки на сервері) ---
...
async def on_guild_channel_create(gc):
    ...
    embed = discord.Embed(title="🆕 СТВОРЕНО НОВИЙ КАНАЛ", color=0x9370db)
...
# =========================================================================
# ТОКЕН — ТІЛЬКИ ЗІ ЗМІННОЇ ОТОЧЕННЯ, НІКОЛИ НЕ ПИШИ ЙОГО В КОД
# =========================================================================
