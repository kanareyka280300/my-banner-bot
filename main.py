...
GTA_ROLE_ID = 123456789012345678        # 1. ВСТАВТЕ СЮДИ ID РОЛІ GTA
TICKET_CATEGORY_ID = 123456789012345678 # 2. ВСТАВТЕ СЮДИ ID КАТЕГОРІЇ ДЛЯ ЗАЯВОК
ADMIN_LOG_CHANNEL_ID = 123456789012345678 # 3. ВСТАВТЕ СЮДИ ID КАНАЛУ "керівництво"
    ...
    if gta_role in after.roles and gta_role not in before.roles:
        ...
        embed_rules = discord.Embed(
            ...
            description=f"Привіт, {after.mention}! Ти обрав роль гравця GTA.\n\n"
                        ...
                        f"🔗 [**ПОСИЛАННЯ_НА_ВАШ_САЙТ_ТУТ**](https://your-gta-site.com)\n"
                        f"3. Обов'язково зайди в канал **<#ID_КАНАЛУ_ОГОЛОШЕННЯ>** та ознайомся з важливою інформацією.\n\n"
